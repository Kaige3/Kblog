...
public class CommentController {
    ...
    public Result comments(@RequestParam Integer page,
        ...
        List<PageComment> pageCommentList = commentService.getPageCommentList(page, blogId, -1L);

        PageResult<PageComment> pageResult = new PageResult<>();
        pageResult.setList(pageCommentList);
        pageResult.setTotalPage((long) pageCommentList.size());
    ...
    public Result postComment(@RequestBody Comment comment,
        ...
        //父评论
        com.kaige.entity.Comment parentComment = null;
